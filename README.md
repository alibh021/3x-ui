...
[![](https://img.shields.io/github/v/release/mhsanaei/3x-ui.svg)](https://github.com/alibh021/3x-ui/releases)
...
- USDT (TRC20): `TMnkxFBiJnV2RY7euM7ZMC9jcLPKFkS85s`

## Install & Upgrade

```
bash <(curl -Ls https://raw.githubusercontent.com/alibh021/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/alibh021/3x-ui/master/install.sh) v2.3.0
```
